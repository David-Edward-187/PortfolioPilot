  ...
  return (
    <>
      <div className="py-20 md:py-24">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16 items-start bg-card border-border p-8 md:p-12 rounded-lg shadow-xl"> {/* Using rounded-lg, shadow-xl */}
