...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className={`container mx-auto section-reveal ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="max-w-xl mx-auto glassmorphic p-8 md:p-10 rounded-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
             <Button 
              ...
              <div className="flex gap-4">
                <a href={resumeData.contact.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-primary transition-colors">
                  <GithubLogo size={28} />
                </a>
                 <a href={resumeData.contact.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary transition-colors">
