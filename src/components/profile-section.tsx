      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6 mb-10">
          <Button
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/80 px-8 py-3 text-base shadow-lg hover:shadow-primary/50 transform hover:scale-105 transition-transform duration-300 group"
        ...
        <div className="flex justify-center space-x-6">
          <a href={profile.contact.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-primary transition-colors">
            <Github className="h-7 w-7" />
          </a>
          <a href={profile.contact.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary transition-colors">
            <Linkedin className="h-7 w-7" />
          </a>
          <a href={`mailto:${profile.contact.email}`} aria-label="Email" className="text-muted-foreground hover:text-primary transition-colors">
